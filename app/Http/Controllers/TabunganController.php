...
class TabunganController extends Controller
{
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('tabungan.show', compact('nasabah', 'mutasi', 'setoranItems', 'bulan', 'tahun', 'tahunTersedia'))
    ...
    public function exportPdf(Request $request, $id)
    {
        ...
        $pdf = Pdf::loadView('tabungan.pdf', compact('nasabah', 'mutasi', 'setoranItems', 'bulan'));
