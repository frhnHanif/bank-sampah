...
<script>
    function openCreate() {
        categoryTitle.textContent='Tambah Jenis Sampah';
        categoryForm.action=@json(route('kategori.store'));
        methodField.value='POST';
        categoryName.value='';
        categoryFactor.value='';
        categoryModal.classList.remove('hidden');
        categoryModal.classList.add('flex');
    }
    function openEdit(item) {
        categoryTitle.textContent='Edit Jenis Sampah';
        categoryForm.action=@json(url('/kategori'))+'/'+item.id;
        methodField.value='PUT';
        categoryName.value=item.name;
        categoryFactor.value=item.factor||'';
        categoryModal.classList.remove('hidden');
        categoryModal.classList.add('flex');
    }
