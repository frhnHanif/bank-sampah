...
<head>
    ...
    <title>Bank Sampah — Login Pengurus</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-4">
            <span class="inline-block bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-bold px-4 py-1.5 rounded-full">
